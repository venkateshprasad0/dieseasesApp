...
public class DiseaseShStrategy implements IndianDiseaseStat {
    ...
    public String GetActiveCount() {
    	...
    	try {
            ...
            DiseaseShResponse diseaseShResponse = new DiseaseShResponse();
            diseaseShResponse = getDiseaseShResponseResponses();

            //get the response using the getCases() method
            //return the response after rounding it up to 0 decimal places
            return diseaseShResponse.getCases().intValue()+"";
        }
    	...
    	//catch block
            ...
            //log the error
            logger.error("Error cannot fetch the details");
